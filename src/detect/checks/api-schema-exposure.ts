...
//
// Confirms via body signatures (version field + info/paths). When a paths
// object is present the finding is high severity. Consumes scanner-attached
// body signals when available.
...
export const apiSchemaExposureCheck: Check = {
  ...
  run(probe: ProbeResult): Finding[] {
    ...
    // OpenAPI / Swagger document with confirmed version marker.
